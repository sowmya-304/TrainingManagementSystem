...
//   const handleApply = async (trainingId, courseName, description, startDate, endDate) => {
//     if (!appliedCourses.some((course) => course.trainingId === trainingId)) {
//       // Retrieve userId and employeeId from session storage
//       const userId = sessionStorage.getItem('uid');
//       const employeeId = sessionStorage.getItem('employeeId');

//       // Apply for the course with userId and employeeId
//       const appliedCourse = {
//         trainingId,
//         CourseId: userId, // Change this to match your data structure
//         courseName,
//         startDate,
//         endDate,
//         userId, // Include userId obtained from session storage
//         employeeId, // Include employeeId obtained from session storage
//       };
...
//             {appliedCourses.map((course) => (
//               <li key={course.trainingId}>
//                 Training ID: {course.trainingId}, Course ID: {course.CourseId}, Course Name: {course.courseName}, Start Date: {course.startDate}, End Date: {course.endDate}, User ID: {course.userId}, Employee ID: {course.employeeId}
//               </li>
//             ))}
//           </ul>
//         </div>
