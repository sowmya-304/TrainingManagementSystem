          ...
          <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <div className="container-fluid">
              ...
              <div className="navbar-nav">
                ...
                {isUserLoggedIn && userRole === 'Manager' && (
                  <>
                    <Link to="/HomeManager/EmployeeDataMgr" className="nav-item nav-link">
                      Employee Data
                    </Link>
                    <Link to="/HomeManager/TrainingRegistration" className="nav-item nav-link">
                      Training Registration
                    </Link>
                    <Link to="/HomeManager/ViewFeedBack1" className="nav-item nav-link">
                      View Feedback
                    </Link>
                    <Link to="/HomeManager/Attendance1" className="nav-item nav-link">
                      Attendance
                    </Link>
...
//                   ViewFeedBack
//                   </Link><br/>
//                   <Link to="/HomeManager/Attendance" className="nav-item nav-link">
//                   Attendance
//                   </Link>
//                  </div>
